<template>
    <div class="wrapper1">
                ...
                <div class="mengceng">
                    ...
                    <div class="center">
                        <div class="title-box">
                            ...
                            <p class="title">Лидер в розничной Торговле</p>
                            <p class="text-box">Shopvill Prime -- Хорошая жизнь-это не дорого!
                            </p>
                        </div>
                        <div class="text"></div>
                    </div>
                ...
                <div class="main">
                    <div class="main-left">
                        ...
                        <div class="photo">
                            ...
                            <div class="text">
                                <h3>
                                    В оффлайн розничных магазинах мало товаров, низкое качество и высокие цены.
                                </h3>
                                <p> 
                                    В настоящее время ассортимент товаров в оффлайн розничных каналах ограничен и имеет низкое качество, в то же время из-за слишком большого количества звеньев в об и высоких цен на товары не могут удовлетворить потребности российских потребителей.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="main-right">
                        <div class="photo-top">
                            ...
                            <div class="text">
                                ...
                                <p>
                                    В среднем россияне тратят около 35 000 рублей в год на покупку одежды, обуви, мебели, предметов быта Население страны составляет 146 миллионов человек, а рыночная мощность страны приближается к 5 триллионам рублей в год.
                                </p>
        ...
        <div class="contionter lingshou-height">
            <div class="lingshou ">
                <div class="main">
                    <div class="title-t">Почему у нас цены ниже?</div>
                    <div class="content">
